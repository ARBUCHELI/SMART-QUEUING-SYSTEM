...
This is a Smart Queuing System built with Python and Intel library OpenVino.  The performance of the system can be tested on the Intel DevCloud using multiple hardware types
...
(Take a look to the jupyter notebooks).
  ...
  * <strong>Step 3: Manufacturing scenario.</strong>
  * <strong>Step 4: Retail scenario.</strong>
  * <strong>Step 5: Transportation scenario.</strong>
